...
urlpatterns = [
    ...
    path("app/android/latest.json", core_views.android_app_latest, name="android-app-latest"),
    ...
    path("markets/<slug:slug>/position-preview/", market_views.position_action_preview, name="position-action-preview"),
    path("markets/<slug:slug>/position-actions/confirm/", market_views.confirm_position_action, name="position-action-confirm"),
    ...
    path("email-confirm/confirm/<str:token>/", account_views.email_confirm_view, name="email-confirm"),
    path("email-confirm/resend/", account_views.email_confirmation_resend_view, name="email-confirm-resend"),
    path("auth/social/<str:provider>/start/", account_views.social_auth_start_view, name="social-auth-start"),
    path("auth/social/<str:provider>/callback/", account_views.social_auth_callback_view, name="social-auth-callback"),
    path("auth/social/email/", account_views.social_auth_email_view, name="social-auth-email"),
    ...
    path("admin-ops/email-policy/footer/", admin_ops_views.email_footer_template, name="admin-ops-email-footer"),
    path("admin-ops/email-policy/logs/", admin_ops_views.email_delivery_logs, name="admin-ops-email-delivery-logs"),
