...
PUSH_TABLES = (
    "gotrendlabs_push_devices",
    "gotrendlabs_push_event_policies",
    "gotrendlabs_push_templates",
    "gotrendlabs_push_deliveries",
    "gotrendlabs_push_preferences",
)


def grant_push_runtime_permissions(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("communications", "0003_push_notifications"),
    ]

    operations = [
        migrations.RunPython(grant_push_runtime_permissions, migrations.RunPython.noop),
    ]
