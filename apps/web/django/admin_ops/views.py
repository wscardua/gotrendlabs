...
AI_ACTION_REASON_COPY = {
    ...
    "market_ai_comment_limit": ("Limite por mercado", "Este mercado já atingiu o total configurado de comentários IA visíveis."),
...
def _ai_agent_initial(agent):
    return {
        ...
        "max_comments_per_market_override": agent.get("max_comments_per_market_override"),
