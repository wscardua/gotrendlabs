...
- A FastAPI vive em `apps/api/backend_api/`; apps Django, `templates/`, `static/`, `deploy/`, `docker/` e `scripts/ops/` continuam nos caminhos atuais ate suas migracoes físicas.
