...
- A FastAPI vive em `apps/api/backend_api/`; deploy, scripts operacionais e Docker local vivem em `ops/`; apps Django, `templates/` e `static/` continuam nos caminhos atuais ate suas migracoes físicas.
