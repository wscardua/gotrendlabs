---
name: gotrendlabs-spec-orchestrator
description: Use esta skill para conduzir o desenvolvimento do GoTrendLabs a partir das specs técnicas, contratos, arquitetura, testes e memória operacional, sem depender do histórico da conversa.
---
