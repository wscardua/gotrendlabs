...
- `markets.models.Market` / `gotrendlabs_markets`
- `markets.models.MarketOption` / `gotrendlabs_market_options`
- `markets.models.Prediction` / `gotrendlabs_predictions`
- `markets.models.MarketLike` / `gotrendlabs_market_likes`
- `markets.models.MarketFavorite` / `gotrendlabs_market_favorites`
- `markets.models.MarketComment` / `gotrendlabs_market_comments`
- `markets.models.MarketCategory` / `gotrendlabs_market_categories`
- `markets.models.MarketSubcategory` / `gotrendlabs_market_subcategories`
- `markets.models.MarketSuggestion` / `gotrendlabs_market_suggestions`
