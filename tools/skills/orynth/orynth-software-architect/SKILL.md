---
name: orynth-software-architect
description: Use esta skill para definir arquitetura profissional, estrutura de sistemas, segurança, modularidade, escalabilidade, auditabilidade e decisões técnicas do Orynth antes de novas features, alterações relevantes ou implementação sensível.
---
...
Propor arquitetura de software eficiente, segura e sustentável para features e mudanças do Orynth, antes da implementação.
...
7. Encaminhar para `orynth-architecture-guard` validar aderência ao desenho.
...
- Se o design exigir mudar a spec, volte para `orynth-spec-editor`.
