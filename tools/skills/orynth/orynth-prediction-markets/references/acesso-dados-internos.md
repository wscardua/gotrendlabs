...
Consulte dados internos antes de usar redes sociais. A Orynth ja possui historico de mercados e metricas que devem orientar ranking, diversidade e anti-repeticao.

## Fontes Internas

Modelos/tabelas relevantes:

- `markets.models.Market` / `orynth_markets`
- `markets.models.MarketOption` / `orynth_market_options`
- `markets.models.Prediction` / `orynth_predictions`
- `markets.models.MarketLike` / `orynth_market_likes`
- `markets.models.MarketFavorite` / `orynth_market_favorites`
- `markets.models.MarketComment` / `orynth_market_comments`
- `markets.models.MarketCategory` / `orynth_market_categories`
- `markets.models.MarketSubcategory` / `orynth_market_subcategories`
- `markets.models.MarketSuggestion` / `orynth_market_suggestions`
...
- `accounts.api_client.get_markets`
- `accounts.api_client.admin_get_markets`
- `accounts.api_client.admin_get_dashboard_summary`
