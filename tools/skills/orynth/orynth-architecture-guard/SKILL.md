---
name: orynth-architecture-guard
description: Use esta skill para validar fronteiras arquiteturais do Orynth, impedir mistura de responsabilidades entre camadas e revisar impactos estruturais de novas features ou mudanças de spec.
---
