---
name: orynth-test-strategy
description: Use esta skill para definir critérios de aceite, cenários de teste e impacto de regressão das features do Orynth com base nas specs técnicas e nos contratos compartilhados.
---
