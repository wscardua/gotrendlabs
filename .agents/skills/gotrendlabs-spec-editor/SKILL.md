---
name: gotrendlabs-spec-editor
description: Use esta skill para derivar, traduzir, normalizar e atualizar specs técnicas do GoTrendLabs a partir da spec funcional, preservando rastreabilidade, impacto controlado e memória operacional do projeto.
---
