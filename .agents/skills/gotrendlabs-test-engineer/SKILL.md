---
name: gotrendlabs-test-engineer
description: Use esta skill para implementar, revisar e executar testes concretos de backend, frontend, contratos, banco, HTMX, APIs, fluxos e regressões do GoTrendLabs a partir da estratégia de testes e critérios de aceite.
---
...
3. Ler saída esperada de `gotrendlabs-test-strategy`.
