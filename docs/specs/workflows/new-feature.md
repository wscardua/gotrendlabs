...
4. Passar por `gotrendlabs-software-architect` para desenho técnico, segurança e impactos.
5. Criar ou atualizar contratos necessários.
6. Validar fronteiras com `gotrendlabs-architecture-guard`.
7. Definir testes esperados e critérios de aceite com `gotrendlabs-test-strategy`.
8. Definir testes executáveis esperados com `gotrendlabs-test-engineer` quando houver código.
