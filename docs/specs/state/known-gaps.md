...
- FEAT-OPSLOG-001 cobre logs técnicos persistidos, redaction, retenção e consulta staff paginada; ainda faltam alertas, integração externa de observabilidade e métricas operacionais temporais mais ricas.
