# Guia: Skill GoTrendLabs Prediction Markets

Use a skill `gotrendlabs-prediction-markets` para gerar sugestoes de mercados de previsao baseadas nos dados internos da GoTrendLabs e em trends verificaveis de redes sociais/fontes publicas.
...
- usar os mercados mais visualizados/curtidos/participados da GoTrendLabs como sinal
...
```text
Use $gotrendlabs-prediction-markets para sugerir 10 mercados de previsao para a GoTrendLabs.
...
- APIs oficiais
- web search
- ORM, banco ou APIs internas da GoTrendLabs
