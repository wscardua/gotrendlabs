# Avaliação Simulada do Mock Orynth
...
- Objetivo: entender rápido o que é a Orynth e fazer a primeira previsão.
...
- Problemas encontrados:
  ...
  - O campo "Reward bruto se acertar 161 OC" parece exato demais para algo explicado depois como fórmula não totalmente pública.
...
- Usuários entendem rapidamente "prever" e "ranking", mas demoram a entender:
  ...
  - quando OC volta, trava ou é perdida;
